...
const Footer = () => {
    return (
        <footer className="container py-24 md:py-12 bg-blue-950">
            <div className="px-6 md:mx-auto space-y-6 md:flex md:px-16">
                <div className='grid grid-cols-2 gap-y-10 md:w-1/2'>
                ...
                <div className="flex flex-col items-center w-full gap-6 px-6 md:order-first md:w-1/2">
